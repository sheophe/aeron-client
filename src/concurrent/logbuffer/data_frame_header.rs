...
lazy_static! {
    pub static ref FRAME_LENGTH_FIELD_OFFSET: Index =
        offset_of!(DataFrameHeaderDefn, frame_length) as Index;
    ...
    pub static ref TERM_OFFSET_FIELD_OFFSET: Index =
        offset_of!(DataFrameHeaderDefn, term_offset) as Index;
    pub static ref SESSION_ID_FIELD_OFFSET: Index =
        offset_of!(DataFrameHeaderDefn, session_id) as Index;
    pub static ref STREAM_ID_FIELD_OFFSET: Index =
        offset_of!(DataFrameHeaderDefn, stream_id) as Index;
    pub static ref TERM_ID_FIELD_OFFSET: Index = offset_of!(DataFrameHeaderDefn, term_id) as Index;
    pub static ref RESERVED_VALUE_FIELD_OFFSET: Index =
        offset_of!(DataFrameHeaderDefn, reserved_value) as Index;
}
